    ...
    <PageTransition>
      <div className="landing-container">
        ...
        <div className="landing-quiz-template-wrapper">
          ...
          <p>
            After seeing a Logical Fallacy definition, select the correct name:
          </p>
          <div className="landing-quiz-template-buttons">
            <Link to="/descriptions" className="landing-quiz-button">
              Start Descriptions Quiz
            </Link>
          </div>
        </div>
      </div>
...
export default LandingDescriptions;
